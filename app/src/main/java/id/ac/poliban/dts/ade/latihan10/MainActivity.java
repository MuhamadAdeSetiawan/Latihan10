package id.ac.poliban.dts.ade.latihan10;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPhone.setOnClickListener(view -> {
            Uri uri = Uri.parse("tel: 082251317395");
        ...
        btEmail.setOnClickListener(view -> {
            Uri uri = Uri.parse("mailto:adesetiawn54321@gmail.com");
            Intent intent = new Intent();
            intent.setAction(Intent.ACTION_VIEW);
            intent.setData(uri);
            startActivity(intent);
        ...
        btWebsite.setOnClickListener(view -> startActivity(new Intent (Intent.ACTION_VIEW, Uri.parse("https://github.com/MuhamadAdeSetiawan"))));
